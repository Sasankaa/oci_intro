...
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE001.PNG)
...
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE002.PNG)

## Practice-2: Upload Object and create pre authenticated link

1. Click the Apps icon in the toolbar and select  Git-Bash to open a terminal window.

![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE004.PNG)

2. Change directory to the Downloads folder Enter command:
```
$ cd /c/Users/PhotonUser/Downloads/**
```
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE005.PNG)
...
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE006.PNG)

5. Bucket detail window should be visible. Click **Upload Object**
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE007.PNG)
...
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE008.PNG)
...
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE009.PNG)
...
12. Click **Close**
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE010.PNG)

13. Open a new browser window and paste Pre-Authenticated link. 
![](/L100-LAB/Object_Storage/media/OBJECT-STORAGE011.PNG)
